import torch
import numpy as np
import qec.vmpo.utils as utils
from rlpyt.algos.base import RlAlgorithm
from qec.vmpo.popart_normalization import PopArtLayer
...
class VMPO(RlAlgorithm):
    ...
    def optimize_agent(self, itr, samples=None, sampler_itr=None):
        ...
        for _ in range(self.epochs):
            for idxs in iterate_mb_idxs(B, mb_size, shuffle=True):
                ...
                dist_info, value, _  = self.agent(*agent_inputs[:, idxs], init_rnn_state)
    ...
    def loss(self, dist_info, value, action, return_, advantage, valid, old_dist_info, opt_info):
        ...
        advantage = advantage.clamp_max(40)  # clamp due to numerical instability of exp function
        ...
        top_advantages, top_advantages_indeces = torch.topk((valid * torch.exp(advantage)).reshape(T * B),
                                                            num_valid // 2)
        top_advantages = torch.log(top_advantages)
