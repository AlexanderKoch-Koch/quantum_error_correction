...
class Surface_Code_Environment_Multi_Decoding_Cycles(gym.Env):
    """
    ...
    def load_static_decoder(self):
        ...
        if self.error_model == 'X':
            static_decoder_path = os.path.dirname(__file__) + '/referee_decoders/nn_d5_X_p5'
        else:
            static_decoder_path = os.path.dirname(__file__) + '/referee_decoders/nn_d5_DP_p5'
